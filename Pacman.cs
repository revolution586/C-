...
namespace Pacman 
{
	...
	public class Pacman
	{
		...
		public void MovePacman(int direction)
		{
			...
			if (!CanMove) { CanMove = check_direction(currentDirection);
		...
		private void CheckPacmanPosition()
		{
			...
			switch (Form1.gameboard.Matrix[yCoordinate, xCoordinate]) 
			{
				...
				case 2: Form1.food.EatSuperGood(yCoordinate, xCoordinate); break;
			}
		}
		...
		private bool check_direction(int direction)
		{
			...
			switch (direction)
			{
				...
				case 3: return direction_ok(xCoordidnate, yCoordinate + 1);
		...
		private bool direction_ok(int x, int y)
		{
			...
			if (x > 27) { xCoordinatte = 0; PacmanImage.Left = -5; return true; }
